 ...
 * Resolving Project process has the meaning for {@link ReconcilingStrategy}.
...
public interface ResolvingProjectStateHolder {
    ...
    /**
     * Returns the current state for Resolving Project process.
     * See {@link ResolvingProjectState}
     */
    ResolvingProjectState getState();

    /**
     * Sets the current state of Resolving Project process.
     *
     * @param state
     *         the current state of Resolving Project process, see {@link ResolvingProjectState}
     */
    void setState(ResolvingProjectState state);

    /**
     * Adds {@link ResolvingProjectStateListener} that should be called
     * every time when the state of Resolving Project process has been changed.
     */
    void addResolvingProjectStateListener(ResolvingProjectStateListener listener);

    /**
     * Removes {@link ResolvingProjectStateListener} to don't get notification about changes of the state of Resolving Project process.
     */
